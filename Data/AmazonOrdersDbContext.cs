...
public partial class AmazonOrdersDbContext : DbContext
{
    public AmazonOrdersDbContext()
    {
    }

    public AmazonOrdersDbContext(DbContextOptions<AmazonOrdersDbContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=SUPERPOTATO;Initial Catalog=AmazonOrdersDB;Integrated Security=True;Encrypt=False;Trust Server Certificate=True");
